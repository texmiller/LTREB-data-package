...
However, we compared the sensitivity to either annual or seasonal SPEI of S+ growth rates \tom{($\frac{\Delta\lambda_{S+}}{\Delta SPEI}$)}{Can you drop the S and just show + and -? The S makes it look like stochastic lambda, which it is not.} with those of S- populations ($\frac{\Delta\lambda_{S-}}{\Delta SPEI}$)(Fig. S25; Table S3).
