...
\dropcap{C}lassic ecological theory predicts that long-term population growth rates will be reduced by environmental variability \cite{lewontin_population_1969,tuljapurkar_population_1982}. Along with increases in average temperatures, global climate change is driving increases in the variability of precipitation events, temperature extremes, and droughts \cite{IPCC2012managing, seneviratne2012changes, stocker2013technical}. In stochastic environments, populations can expect to experience good years and bad years. The long-term stochastic growth rate ($\lambda_s$), which is the long-run geometric mean of annual growth rates, captures this varability; This geometric mean will always be less than expected from the mean growth rate alone. 
...
In sum, our dataset of individual-level demography covers 14 years and contains 30,XXXX individual transition-years.
